...
export default function Profile() {
  ...
  if (loading) {
    return (
      <div className="space-y-6 max-w-2xl mx-auto p-4 sm:p-6 animate-pulse">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 space-y-6 h-96" />
      </div>
    );
  }
  ...
  return (
    <div className="p-4 sm:p-6 max-w-2xl mx-auto space-y-6 font-poppins bg-gray-50/20 min-h-screen">
      <div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-200/60 shadow-sm space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-5">
          <div className="relative group">
            ...
            <label className="absolute -bottom-1.5 -right-1.5 p-1.5 bg-white border border-gray-200 rounded-lg shadow-sm cursor-pointer hover:bg-gray-50 transition-colors block">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 bg-gray-50/50 rounded-xl border border-gray-100">
          <div>
            <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider flex items-center gap-1">
              <Truck size={10} className="text-gray-400" /> Vehicle
            </span>
          ...
          <div>
            ...
            <span className="text-[9px] text-gray-400 font-medium">Rating Level</span>
          </div>
          ...
          <div>
            ...
            <span className="text-[9px] text-gray-400 font-medium">Closed Logs</span>
          </div>
          ...
          <div>
            ...
            <span className="text-[9px] text-gray-400 font-medium">Gross Wallet</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-2">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-gray-200/80 rounded-xl pl-10 pr-4 py-2.5 text-xs font-medium text-gray-800 focus:outline-none focus:border-gray-300 transition-colors placeholder:text-gray-300"
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Vehicle Plate Registration</label>
              <div className="relative">
                <Truck size={14} className="absolute left-3.5 top-3.5 text-gray-400" />
                <input
                  type="text"
                  name="vehicleNumber"
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Vehicle Transport Mode</label>
              <select
                name="vehicleType"
                value={formData.vehicleType}
                onChange={handleChange}
                className="w-full bg-white border border-gray-200/80 rounded-xl px-4 py-2.5 text-xs font-medium text-gray-800 focus:outline-none focus:border-gray-300 transition-colors appearance-none cursor-pointer"
              >
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Base Hub / Address</label>
            <div className="relative">
