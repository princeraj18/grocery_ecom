...
export default function Orders() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto space-y-8 font-poppins bg-gray-50/30 min-h-screen pb-24 md:pb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Total Payout Balance</p>
        ...
        <div 
          ...
          className={`p-5 rounded-2xl bg-white border transition-all cursor-pointer ${
            activeTab === "pending" 
              ? "border-amber-500 shadow-sm ring-1 ring-amber-500/10" 
              : "border-gray-200/60 hover:border-gray-300"
          }`}
        >
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Active Duties</p>
      ...
      <div className="space-y-4">
        {filteredOrders.length === 0 ? (
          <div className="bg-white py-14 px-6 rounded-2xl border border-gray-200/60 text-center">
          ...
          filteredOrders.map((order) => (
            <div
              ...
              className="bg-white p-5 rounded-2xl border border-gray-200/60 flex flex-col lg:flex-row lg:items-center justify-between gap-5 cursor-pointer hover:border-gray-300 transition-all duration-200"
            >
              ...
              <div className="space-y-2 lg:w-44 text-left lg:text-right">
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block leading-none">Payout Earnings</p>
                  ...
                  {order.deliveryStatus === "Assigned" && (
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="bg-white hover:bg-gray-50 text-red-600 border border-gray-200 text-[10px] font-bold uppercase tracking-wider px-4 py-2.5 rounded-xl transition-colors"
                      >
                        Reject
                      </button>
                    </div>
