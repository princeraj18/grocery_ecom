...
export default function DeliveryRegister() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-slate-950 flex items-center justify-center p-4 py-12 relative">
      <div className="absolute top-4 right-4">
        <ThemeToggle />
      </div>
      <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl w-full max-w-lg border border-gray-200 dark:border-slate-800 shadow-xl">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Join the Fleet</h2>
          <p className="text-gray-500 dark:text-slate-400 mt-2">Earn on your own schedule</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleRegister}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Vehicle Type</label>
              <select
                name="vehicleType"
                value={formData.vehicleType}
                onChange={handleInputChange}
                className={`${inputClassName} bg-[image:none]`}
              >
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Vehicle Number</label>
              <input
                type="text"
                name="vehicleNumber"
