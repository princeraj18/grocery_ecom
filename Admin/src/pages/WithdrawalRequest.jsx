      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {["all", "Pending", "Approved", "Rejected"].map((status) => (
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-semibold transition-colors ${ statusFilter === status ? "bg-indigo-600 text-white" : "bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-800 hover:bg-slate-600 dark:bg-slate-900" }`}
          >
              ...
              <tbody className="divide-y divide-slate-50">
                {filteredRequests.map((request) => {
                  ...
                  return (
                    <tr
                      key={request._id}
                      className="hover:bg-slate-700 dark:bg-slate-900/50 transition-colors"
                    >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <button
                              ...
                              className="font-semibold text-slate-800 dark:text-slate-100 hover:text-indigo-600 transition-colors text-left"
                            >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold border ${ STATUS_STYLES[request.status] || "bg-slate-50 dark:bg-slate-900 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-800" }`}
                        >
